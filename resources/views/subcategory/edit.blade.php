              ...
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ url('/subcategory') }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="name" required="required" class="form-control col-md-7 col-xs-12" name="name" value="{{ $subcat->name }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <select id="category" class="form-control col-md-7 col-xs-12" name="category" required="required">
                          ...
                          <option value="">{{ $subcat->catid }}</option>
                          @foreach($cats as $cat)
                          <option value="{{ $cat-> id }}" {{ ($subcat->catid == $cat-> id ? "selected":"") }}>{{ $cat-> name }}</option>
                          @endforeach
                      </select>
